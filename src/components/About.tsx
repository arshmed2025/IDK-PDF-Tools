  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-black text-gray-900 dark:text-zinc-100 selection:bg-sky-500 selection:text-white pb-24">
      ...
      <section className="max-w-5xl mx-auto px-6 mb-20">
        <div className="bg-sky-500 text-white rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-xl shadow-sky-500/20">
           ...
           <div className="flex-1 text-center md:text-left relative z-10">
              ...
              <p className="text-sky-100 font-medium text-base mb-6 max-w-xl leading-relaxed">
                 IDK PDF Tools is self-funded and ad-free. Your support ensures the project stays alive and free for everyone.
              </p>
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                 <a href="https://github.com/sponsors/potatameister" target="_blank" className="px-8 py-3.5 bg-white text-sky-600 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 transition-transform shadow-lg flex items-center gap-2">
                    <HeartIcon size={14} fill="currentColor" /> Sponsor
                 </a>
                 <button onClick={() => navigate('/thanks')} className="px-8 py-3.5 bg-sky-600 text-white border border-sky-400/50 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-sky-700 transition-colors flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-gray-500 dark:text-zinc-400 text-sm font-medium leading-relaxed">
              IDK PDF Tools rejects the trade-off between convenience and privacy. We've built an engine that runs where the user is, ensuring your sensitive data never crosses a network boundary.
            </p>
            <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-sm">
               ...
               <p className="text-xs text-gray-500 dark:text-zinc-400 font-medium leading-relaxed">
                  We operate no backend. No databases. No file caches. IDK PDF Tools is a static distribution of code that activates your browser's existing power.
               </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-white dark:bg-zinc-900 rounded-[2.5rem] p-2 md:p-6 border border-gray-100 dark:border-white/5 shadow-sm">
             ...
             <SpecItem title="Data Lifecycle" icon={PrivacyIcon}>
                Your documents live exclusively in your browser's <span className="text-sky-500 font-bold">volatile memory (RAM)</span>. We do not use persistent storage or cookies for your file content. Once the tab is closed, the data is destroyed.
             </SpecItem>
             ...
             <SpecItem title="Radical Transparency" icon={CodeIcon}>
                IDK PDF Tools is <span className="text-sky-500 font-bold">100% Open Source</span> under the <span className="text-sky-500 font-bold">GNU AGPL v3</span> license. This gives you the right to audit every line of code and guarantees the engine remains free.
             </SpecItem>
      ...
      <section className="max-w-4xl mx-auto px-6 text-center border-t border-gray-100 dark:border-zinc-900 pt-16">
        <div className="flex flex-wrap justify-center gap-8 mb-12">
           <a href="https://github.com/potatameister/PaperKnife" target="_blank" className="flex items-center gap-2.5 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-sky-500 transition-colors group">
           ...
           <button onClick={() => navigate('/thanks')} className="flex items-center gap-2.5 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-sky-500 transition-colors group">
        ...
        <div className="opacity-20 hover:opacity-50 transition-opacity duration-700">
          <PaperKnifeLogo size={32} iconColor="#0EA5E9" partColor="currentColor" className="mx-auto mb-4" />
      ...
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-6 border border-gray-100 dark:border-white/5 shadow-sm flex flex-col items-center text-center">
          <div className="w-20 h-20 bg-gray-50 dark:bg-black rounded-[1.5rem] flex items-center justify-center shadow-inner mb-4">
            <PaperKnifeLogo size={40} iconColor="#0EA5E9" partColor="currentColor" />
          </div>
          <h2 className="text-2xl font-black tracking-tighter dark:text-white leading-none mb-1">IDK PDF Tools</h2>
          <p className="text-[9px] font-black uppercase tracking-widest text-sky-500">v1.0.9 Stable • Absolute Privacy</p>
        </div>

        {/* 2. Fuel the Engine (Prominent Support - MOVED TO TOP) */}
        <div className="bg-sky-500 text-white rounded-[2rem] p-6 relative overflow-hidden shadow-xl shadow-sky-500/20">
           ...
           <div className="relative z-10">
              ...
              <p className="text-sm font-medium text-sky-100 leading-relaxed mb-6">
                 We are 100% self-funded. Your support ensures IDK PDF Tools stays free and open for everyone.
              </p>
              <div className="grid grid-cols-2 gap-3">
                 <a href="https://github.com/sponsors/potatameister" target="_blank" className="flex items-center justify-center gap-2 py-3 bg-white text-sky-600 rounded-xl font-black uppercase text-[9px] tracking-widest shadow-sm active:scale-95 transition-transform">
                    Sponsor
                 </a>
                 <button onClick={() => navigate('/thanks')} className="flex items-center justify-center gap-2 py-3 bg-sky-600 text-white border border-sky-400/50 rounded-xl font-black uppercase text-[9px] tracking-widest active:scale-95 transition-transform">
                    Hall of Fame
                 </button>
              </div>
           </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-2 border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
           ...
           <div className="divide-y divide-gray-50 dark:divide-white/5 px-2">
              <SpecItem title="How it Works" icon={CpuIcon}>
                Every action you perform—merging, splitting, or encrypting—happens locally on your device's CPU. IDK PDF Tools uses an internal local engine powered by <span className="text-sky-500 font-bold">pdf-lib</span> and <span className="text-sky-500 font-bold">WebAssembly</span>. No data ever leaves your hardware.
              </SpecItem>

              <SpecItem title="Data Privacy" icon={PrivacyIcon}>
                Your files are loaded into the app's <span className="text-sky-500 font-bold">volatile memory (RAM)</span> only during your active session. We do not use persistent storage for your PDF content. Once you close the app or navigate away, the processed document is permanently purged.
              </SpecItem>

              <SpecItem title="Deep Metadata Clean" icon={DiskIcon}>
                Privacy isn't just about servers. Most tools leave digital breadcrumbs in the PDF metadata. IDK PDF Tools's "Deep Clean" protocol sanitizes every document, purging Producer, Creator, and XMP metadata to ensure absolute anonymity.
              </SpecItem>

              <SpecItem title="Open Source Integrity" icon={CodeIcon}>
                Trust is earned through transparency. IDK PDF Tools is <span className="text-sky-500 font-bold">100% open-source</span> under the <span className="text-sky-500 font-bold">GNU AGPL v3</span> license. This ensures the engine remains free, auditable, and community-driven forever.
              </SpecItem>

              <SpecItem title="Zero Infrastructure" icon={ServerOffIcon}>
                We operate a <span className="text-sky-500 font-bold">Zero-Server Architecture</span>. We have no backend, no database, and no cloud. Your phone is the laboratory, and your documents stay in your hands alone.
              </SpecItem>
           </div>
        </div>
          ...
          <button onClick={() => navigate('/thanks')} className="flex items-center justify-between p-5 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-[2rem] active:scale-[0.98] transition-all">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-sky-50 dark:bg-sky-900/20 rounded-xl flex items-center justify-center">
                   <SparklesIcon size={20} className="text-sky-500" />
                </div>
